...
%token ID IF ELSE LET CONST VAR FOR FUNCTION WHILE ASM RETURN BOOLEAN PRINT OBJECT
...
E : LVALUE '=' RVALUE 
  ...
  | LVALUEPROP '=' RVALUE
    { checa_simbolo( $1.c[0], true );  $$.c = $1.c + $3.c + "="; }
  | LVALUE MAIS_IGUAL RVALUE 
    { $$.c = $1.c + $3.c + "+="; }
  | LVALUEPROP MAIS_IGUAL RVALUE
    { $$.c = $1.c + $3.c + "+="; }
  | E '<' E
    { $$.c = $1.c + $3.c + $2.c; }
  | E '>' E
